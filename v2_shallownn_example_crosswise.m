...
% 1. read the data
fprintf('\n1. Reading the training and testing data from crosswise dataset ... \n')
fprintf('=========================================\n');

trainingData = readtable('v2_ptrainingData_crosswise.csv');
testingData = readtable('v2_ptestingData_crosswise.csv');
...
for k = 1:10
   ...
   model{k} = train(net,x',y','CheckpointFile', 'checkpoints/crosswise_Checkpoint_'+string(k),'CheckpointDelay',120);
...
%% save the best model
save('models/v2_shallowNN_crosswise.mat', 'model');
